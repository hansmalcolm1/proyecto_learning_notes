...
if(isset($_GET["estudiante_id_alumno"]) && strlen($_GET["estudiante_id_alumno"])>0){
	...
	$sql = "delete from estudiante_has_curso where estudiante_id_alumno=:estudiante_id_alumno";
	...
	window.location.href='ListarEstudiantesHasCursoDB.php?sesion=$sesion&rol=$rol'</script>";
}
else{
