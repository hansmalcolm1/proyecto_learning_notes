...
$sql = "select * from tarea, materia, curso, estudiante_has_curso, estudiante, usuario where materia_idmateria1=idmateria, curso_idcurso.materia=idcurso, curso_idcurso.estudiante_has_curso=idcurso and estudiante_id_alumno=id_alumno and id_usuario=id and usuario='".$_GET['sesion']."'";
$result = $con->prepare($sql);
$result->execute();
$personas = $result->fetchAll(PDO::FETCH_CLASS, "Persona");
}
